...
class SynonymSprintGame extends GameBase {
  ...
  injectStyles() {
    ...
    style.textContent = `
      .ssprint-game{height:600px;overflow:hidden;border-radius:24px;background:linear-gradient(180deg,#a8edea 0%,#fed6e3 100%);font-family:'Fredoka One',cursive,sans-serif;display:flex;align-items:center;justify-content:center;padding:20px}
