...
class BabyPianoGame extends GameBase {
  ...
  injectStyles() {
    ...
    style.textContent = `
      .bpiano-game{min-height:600px;height:auto;overflow:visible;border-radius:24px;background:linear-gradient(180deg,#2d3436 0%,#111 100%);font-family:'Fredoka One',cursive,sans-serif;display:flex;align-items:center;justify-content:center;padding:20px}
