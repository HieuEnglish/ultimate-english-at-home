...
class AlphabetSoupGame extends GameBase {
  ...
  injectStyles() {
    ...
    style.textContent = `
      .asoup-game{height:600px;overflow:hidden;border-radius:24px;background:linear-gradient(180deg,#fff2cc 0%,#fab1a0 100%);font-family:'Fredoka One',cursive,sans-serif;display:flex;align-items:center;justify-content:center;padding:20px}
