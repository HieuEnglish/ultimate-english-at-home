...
class SightWordSafariGame extends GameBase {
  ...
  injectStyles() {
    ...
    style.textContent = `
      .safari-game{height:600px;overflow:hidden;border-radius:24px;background:linear-gradient(180deg,#87CEEB 0%,#E0F6FF 55%,#f6d365 55%,#fda085 100%);font-family:'Fredoka One',cursive,sans-serif;display:flex;align-items:center;justify-content:center;padding:20px}
