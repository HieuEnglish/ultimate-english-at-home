...
(function () {
  ...
  function renderQuestionScreen(state) {
    ...
    const type = String(q.type || "listenChoice").toLowerCase();
  ...
  function renderFeedback(state) {
    ...
    if (t === "listenfillintheblank") {
      ...
      detailHtml = ok
        ...
        : `<p style="margin:8px 0 0">One correct answer: <strong>${safeText(correctText)}</strong></p>
    ...
    const expHtml = explanation
      ? `<div class="note" style="margin:12px 0 0; padding:10px 12px"><strong>Explanation</strong><p style="margin:8px 0 0">${safeText(
          explanation
        )}</p></div>`
      : "";
  ...
  function renderSummary(state) {
    ...
    return `
      <div class="note" style="margin-top:12px">
        ...
        <p style="margin:8px 0 0">Score: <strong>${correct}</strong> / ${total} (${percent}%).</p>
