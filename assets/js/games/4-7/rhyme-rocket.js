...
class RhymeRocketGame extends GameBase {
  ...
  injectStyles() {
    ...
    style.textContent = `
      .rr-game{height:600px;overflow:hidden;border-radius:24px;background:radial-gradient(circle at center,#2c3e50 0%,#000 100%);font-family:'Fredoka One',cursive,sans-serif;display:flex;align-items:center;justify-content:center;padding:20px;color:#fff}
