...
class FruitBasketGame extends GameBase {
  ...
  injectStyles() {
    ...
    style.textContent = `
      .fb-game{height:600px;overflow:hidden;border-radius:24px;background:linear-gradient(180deg,#81ecec 0%,#ffeaa7 100%);font-family:'Fredoka One',cursive,sans-serif;display:flex;align-items:center;justify-content:center;padding:20px}
