...
class WordDetectiveGame extends GameBase {
  ...
  injectStyles() {
    ...
    style.textContent = `
      .wd-game{min-height:600px;height:auto;overflow:visible;border-radius:24px;background:linear-gradient(180deg,#3b4252 0%,#2d3436 100%);font-family:'Fredoka One',cursive,sans-serif;display:flex;align-items:center;justify-content:center;padding:20px}
