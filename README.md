...
- 🆓 **Free-first content** (the priority is always FREE resources)
...
- 🆓 Include **FREE resources first** (no paywalls where possible)
- 🔗 Use **external links** for resources (keep the repo lightweight)
- ✍️ Keep descriptions short, clear, and parent-friendly
...
Found a bug, broken link, or want a feature? Please open an issue here:  
...
- 🆕 Creating new packs (new age group or new skills content)
- 🎮 Adding **simple but effective learning games** (quick to explain, low-prep, high speaking time)
  - Examples: Hangman, Bingo, Memory Match, “I Spy”, 20 Questions, Would You Rather, Speed Vocabulary, Charades
...
Start here:  
https://github.com/HieuEnglish/ultimate-english-at-home/pulls
