...
(function () {
  ...
  function renderQuestionScreen(state) {
    ...
    const optionButtons = options
      .map((opt, i) => {
        const big = isEmojiish(opt) ? "font-size:28px" : "font-size:22px; letter-spacing:.3px";
        return `
          <button
            class="btn"
            type="submit"
          ...
          <table style="width:100%; border-collapse:collapse" aria-label="Answer review table">
            ...
            <thead>
              <tr>
                ...
                <th scope="col" style="text-align:left; padding:10px 10px; border-top:1px solid var(--border); color: var(--muted)">Question</th>
    ...
    afterRender(rootEl, ctx) {
      ...
      function recordReviewRow(q, chosenIdx) {
        ...
        state.review.push({
          ...
          prompt: q && q.question ? String(q.question) : "",
